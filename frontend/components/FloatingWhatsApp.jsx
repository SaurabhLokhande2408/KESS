...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      aria-label="Chat with KESS on WhatsApp"
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-opacity duration-200 hover:opacity-95"
    >
      <svg
        viewBox="0 0 24 24"
